...
const features = [
  {
    ...
    description: (
      <>
        Subscribe to a public SNS topic to get notified when new AWS EKS AMIs come off the press.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Trigger business-specific workflows like rotating AMIs using your own Lambda functions and SQS Queues.
      </>
    ),
  },
];

function Feature({imageUrl, title, description, buyMeACoffee}) {
